...
class SlideIt extends React.PureComponent<{}, ISliderProps> {
   ...
   public render() {
      return (
         ...
         <div className="row">
            ...
            <div className="col">
               <div className={"colorBlock p-2 h-100 border border-dark"} id={"colorBlock"}>
                  <div className="" id={"colorLabel"} />
               </div>
            </div>
         </div>
         </div>
