...
class Knob extends React.PureComponent<{}, IKnobProps> {
   ...
   constructor(props: {}) {
       ...
       const marks = {
           colorProgress: { border: '#00a4e1', color: '#CCB300' },
       ...
       const pointer = {
           offset: '49%', size: '59%',
           style: { fill: '#CCB300', stroke: 'grey' },
           thickness: 20, type: 'arrow'
       };
       const progressBar = {
           background: { fill: 'lightgrey', stroke: 'grey' },
           offset: '60%', size: '9%',
           style: { fill: '#CCB300', stroke: 'grey' }
       };
       this.state = {
       ...
       return (
           <div>
               ...
               <JqxNumberInput ref={this.myNumberInput} onValueChanged={this.onValueChanged}
                   width={80} height={40} decimal={60} min={0} max={100}
